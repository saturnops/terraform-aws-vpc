...
### [SaturnOps Technologies](https://saturnops.com/) Provide end to end solution for all your DevOps needs
...
# IAM Permissions
The required IAM permissions to create resources from this module can be found [here](https://github.com/saturnops/terraform-aws-network/blob/main/IAM.md)
